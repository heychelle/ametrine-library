...
<body class="d-flex flex-column min-vh-100">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background: rgb(251,199,193);">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ asset('/assets/image/logo_new.png') }}" style="width: 50px">
                    {{-- Ametrine Library --}}
...
<footer class="text-center text-white mt-auto" style="background: #fff0f0">
    <!-- Grid container -->
  <div class="container p-4 pb-0">
        ...
        <div class="row d-flex justify-content-center">
          ...
          <div class="col-md-5 col-12">
            ...
            <div class="form-outline mb-4">
              ...
              <label class="form-label text-black" for="form5Example27">Sign up for our newsletter</label>
            </div>
          </div>
          <!--Grid column-->
    ...
    <!-- Copyright -->
    <div class="text-center text-dark p-3 shadow-sm" style="background: rgb(251,199,193);">
      © 2020 Copyright:
