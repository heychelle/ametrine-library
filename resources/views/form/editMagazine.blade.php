                ...
                <form action="{{ route('magazines.update', $magazine->id) }}" method="POST"> 
                    ...
                    <div class="mb-3">
                        ...
                        <select name="status" id="" class="form-select">
                            <option value="0" @if ($magazine->status == '0') selected @endif>Available</option>
                            <option value="1" @if ($magazine->status == '1') selected @endif>Borrowed</option>
                            <option value="2" @if ($magazine->status == '2') selected @endif>Due</option>
                            <option value="3" @if ($magazine->status == '3') selected @endif>Booked</option>
                        </select>
                    </div>
                    <div class="mb-3">
